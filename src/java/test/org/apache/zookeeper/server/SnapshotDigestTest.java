...
public class SnapshotDigestTest extends ClientBase {
    ...
    private void testCompatibleHelper(
            String enabledBefore, String enabledAfter) throws Exception {

        System.setProperty(
                AbstractDigestCalculator.ZOOKEEPER_DIGEST_ENABLED, enabledBefore);
        ...
        System.setProperty(
                AbstractDigestCalculator.ZOOKEEPER_DIGEST_ENABLED, enabledAfter);
